...
class GetFolderStructureFromZimbraTest extends ZasaModuleTestCase
{
     ...
     * @test
     */
    public function correctlyHandlesCaseWhereOnlyOneLinkExists()
    {
        $this->zasa->shouldReceive('getFolders')->andReturn($this->folderResponseWithOneLink());
        $this->module->getFolderStructureFromZimbra(null);
        $result = $this->module->grabResultFromZimbra();
        $this->assertEquals([
            'name' => 'USER_ROOT',
    ...
    private function folderResponseWithOneLink()
    {
        return [
            'folder' =>
                [
